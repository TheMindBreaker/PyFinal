...
while True:
    try:
        a = float(input("Ingresa valos A: "))
        b = float(input("Ingresa valos B: "))
    except ValueError:
        print("Error valor no es un INT .")
        continue
    else:
        break
elipse = math.sqrt((2**2)*((a+b)**2))
print("|============================================================|")
print("Los valores dados son || A ==>",a," y B ==>",b)
print("La circunferencia es ==>",elipse)
